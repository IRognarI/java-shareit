...
/**
 * Контроллер для управления бронированиями в системе ShareIt
 * Данный контроллер предоставляет REST API для работы с бронированиями, включая создание,
 * обновление и получение информации о бронированиях. Все операции выполняются с учетом
 * идентификатора пользователя, передаваемого в HTTP-заголовке X-Sharer-User-Id.
 *
 */
